  ...
  return (
    <div className="grid grid-cols-2 items-center gap-7">
      ...
      <div className="col-span-2 lg:col-span-1">
        ...
        >
          <h3>
            Bonjour, je suis <span className="text-primary">Collet Gautier</span>
          </h3>
          ...
          <a href="https://www.colletg-photography.be/" target="_blank" rel="noopener noreferrer" className="btn mt-3">
            <span>SITE WEB MARIAGE</span>
          </a>
        </motion.div>
      </div>
    </div>
